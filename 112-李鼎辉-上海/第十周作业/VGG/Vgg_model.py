...
def vgg_16(inputs, num_class=1000, is_training=True,dropout_keep_prob=0.5, spatial_squeeze=True,scope='vgg_16'):
    with tf.variable_scope(scope,'vgg_16',[inputs]):
        ...
        # conv3三次[3,3]卷积网络，输出特征为256，输出nete为(56,56,256)
        ...
        # 利用卷积的方式模拟全连接层，效果等同，输出为net为(1,1,4096)
        net = slim.conv2d(net,4096,[1,1],scope='fc7')
        net = slim.dropout(net,dropout_keep_prob,is_training=is_training,scope='dropout7')
        # 利用卷积分方式模拟全连接层，效果等同，输出net为（1，1，1000）
