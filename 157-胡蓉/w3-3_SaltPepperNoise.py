...
# 调用自定义函数实现高斯噪声
img2 = SaltPepperNoise(img1, 0.02)

# 将灰度图与高斯噪声图拼接在一起显示
cv2.imshow('gray_SaltPepperNoise', np.hstack([img1, img2]))
...
# 将原图与高斯噪声图拼接在一起显示
cv2.imshow('bgr_SaltPepperNoise',  np.hstack([img_show, noise_gs_img_show]))
cv2.waitKey(0)
