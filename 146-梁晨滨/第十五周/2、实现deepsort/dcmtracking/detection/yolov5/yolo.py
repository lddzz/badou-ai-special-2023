...
class YOLO(object):
    _defaults = {
        ...
        # --------------------------------------------------------------------------#
        "model_path": 'dcmtracking/detection/yolov5/model_data/yolov5_n_v6.1.pth',
    ...
    def detect_image(self, image, crop=False, count=False):
        ...
        #
        #     font_color = (0, 0, 0)
        #     if c in OBJ_PASS_INDEX:
        #         color = (0, 255, 0)
        #     elif c in OBJ_UNPASS_INDEX:
        #         color = (255, 0, 0)
        #     elif c == OBJ_INDEX_REN:
        #         color = (0, 0, 255)
