...
images_train,labels_train= cifardata.inputs(data_dir=data_dir, batch_size=batch_size, distorted=True)
images_test,labels_test= cifardata.inputs(data_dir=data_dir, batch_size=batch_size, distorted=None)
